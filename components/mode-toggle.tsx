...
export function ModeToggle() {
    ...
    return (
        ...
        >
            <Sun className="h-[1.2rem] w-[1.2rem] rotate-0 scale-100 transition-all dark:-rotate-90 dark:scale-0 text-[#1a1a1a] dark:text-[#faf9f6]" />
            <Moon className="absolute top-2 left-2 h-[1.2rem] w-[1.2rem] rotate-90 scale-0 transition-all dark:rotate-0 dark:scale-100 text-[#1a1a1a] dark:text-[#faf9f6]" />
        </button>
    )
}
